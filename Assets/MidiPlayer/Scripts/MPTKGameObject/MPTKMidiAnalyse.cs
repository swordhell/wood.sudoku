...
namespace MidiPlayerTK
{
    ...
    public class MPTKTempo
    {
        ...
        public static int MPTK_FindSegment(List<MPTKTempo> tempoMap, long tickSearch, int fromIndex = 0)
        {
        ...
        /// <param name="fromIndex">search from this index position in the list (for optimazation)</param>
        /// <returns>index of the segment</returns>
        public static int MPTK_FindSegment(List<MPTKTempo> tempoMap, float timeSearch, int fromIndex = 0)
        {
            if (tempoMap == null || tempoMap.Count == 0)
                return 0;
        ...
        /// <returns></returns>
        public double MPTK_CalculateTime(long tick)
        {
            return FromTime + (tick - FromTick) * Pulse;
        }

        public long MPTK_CalculatelTick(float time)
        {
        ...
        public static void MPTK_CalculateMap(int deltaTicksPerQuarterNote, List<MPTKEvent> mptkEvents, List<MPTKTempo> temposMap)
        {
            ...
            temposMap.Add(new MPTKTempo(index: 0, microsecondsPerQuarterNote: MPTKEvent.MPTK_BPM2MPQN(120),
                pulse: (double)MPTKEvent.MPTK_BPM2MPQN(120) / (double)DeltaTicksPerQuarterNote / 1000d));
    ...
    public class MPTKSignature
    {
        ...
        /// <param name="tick"></param>
        /// <returns></returns>
        public int MPTK_TickToMeasure(long tick)
        {
        ...
        public static long MPTK_MeasureToTick(List<MPTKSignature> temposMap, int measure)
        {
            long tick = -1;
            //long index = -1;
        ...
        public int MPTK_CalculateBeat(long tick, int measure)
        {
            int beat = 0;
        ...
        public static void MPTK_CalculateMap(int deltaTicksPerQuarterNote, List<MPTKEvent> mptkEvents, List<MPTKSignature> signaturesMap)
        {
            DeltaTicksPerQuarterNote = deltaTicksPerQuarterNote;
            signaturesMap.Clear();
            mptkEvents.ForEach(mptkEvent =>
        ...
        /// </summary>
        /// <param name="signaturesMap"></param>
        public static void MPTK_CalculateMeasureBoundaries(List<MPTKSignature> signaturesMap)
        {
        ...
        /// <param name="fromIndex">search from this index position in the list (for optimazation)</param>
        /// <returns></returns>
        public static int MPTK_FindSegment(List<MPTKSignature> signMap, long tickSearch, int fromIndex = 0)
        {
