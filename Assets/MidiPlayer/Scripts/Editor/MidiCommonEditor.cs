...
namespace MidiPlayerTK
{
    ...
    public class MidiCommonEditor : ScriptableObject
    {
        ...
        public void MidiFileParameters(MidiFilePlayer instance)
        {
            ...
            instance.MPTK_MidiAutoRestart = EditorGUILayout.Toggle(new GUIContent("Restart Midi", "The current MIDI playing is restarted when it reaches the end"), instance.MPTK_MidiAutoRestart);
